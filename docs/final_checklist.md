...
embedded fonts, byte-identical staged copies, and exactly `poster.pdf` plus
`appendix.pdf` in `submission/`.
...
- [ ] Rebuild both PDFs and rerun `scripts/verify_submission.py` after those edits.
